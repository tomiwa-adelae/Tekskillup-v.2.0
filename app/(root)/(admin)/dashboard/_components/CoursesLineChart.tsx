...
const CoursesLineChart = ({ courses }: any) => {
	// Extract dates and count occurrences
	const dateCounts = courses.reduce((acc: any, course: any) => {
		const date = new Date(course.createdAt).toISOString().split("T")[0]; // Extract date part
